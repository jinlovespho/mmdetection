...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            name='epoch50_train4_val4_enc6_dec6_hdim256_query300',
            project='LOCAL_cond_detr'),
        log_code_name=None,
        save_dir=
        '/home/kwangrok/Downloads/VS_CODE/my_github/mmdetection/tools/my_script/detr/train/wandb_results/cond_detr',
...
wandb_path = '/home/kwangrok/Downloads/VS_CODE/my_github/mmdetection/tools/my_script/detr/train/wandb_results/cond_detr'
wandb_project_name = 'LOCAL_cond_detr'
wandb_run_name = 'epoch50_train4_val4_enc6_dec6_hdim256_query300'
work_dir = './train_results/20230813/epoch50_train4_val4_enc6_dec6_hdim256_query300'
