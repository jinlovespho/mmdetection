...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True, test_out_dir='./show_dir_img', type='DetVisualizationHook'))
default_scope = 'mmdet'
embed_dim = 256
encoder_layers = 2
env_cfg = dict(
...
load_from = '/home/kwangrok/Downloads/VS_CODE/my_github/mmdetection/tools/my_script/detr/train/train_results/20230814/epoch300_train4_val2_enc3_dec6_hdim256_query150/epoch_300.pth'
log_level = 'INFO'
...
model = dict(
    ...
    neck=dict(
        ...
        type='ChannelMapper'),
    num_queries=150,
    positional_encoding=dict(normalize=True, num_feats=128.0),
...
weight_decay = 0.0001
work_dir = './test_results/20230820/epoch300_test_on_traindset'
