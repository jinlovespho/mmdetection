...
model = dict(
    ...
    decoder=dict(
        layer_cfg=dict(
            cross_attn_cfg=dict(
                batch_first=True, dropout=0.1, embed_dims=64, num_heads=8),
            ffn_cfg=dict(
    ...
    neck=dict(
        ...
        type='ChannelMapper'),
    num_queries=100,
    positional_encoding=dict(normalize=True, num_feats=32),
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            name='epoch300_train4_val2_enc6_dec6_hdim64',
...
wandb_run_name = 'epoch300_train4_val2_enc6_dec6_hdim64'
work_dir = './train_results/20230813/epoch300_train4_val2_enc6_dec6_hdim64'
