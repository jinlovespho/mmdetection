...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            name='epoch50_train4_val4_enc2_dec2', project='detr_local'),
        log_code_name=None,
        save_dir=
        '/home/kwangrok/Downloads/VS_CODE/my_github/mmdetection/tools/my_script/detr/train/wandb_results/detr_local',
...
wandb_run_name = 'epoch50_train4_val4_enc2_dec2'
work_dir = './train_results/20230812/epoch50_train4_val4_enc2_dec2'
