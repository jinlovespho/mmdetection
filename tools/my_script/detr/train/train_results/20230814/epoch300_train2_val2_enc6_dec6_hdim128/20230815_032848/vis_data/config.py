...
model = dict(
    ...
    decoder=dict(
        layer_cfg=dict(
            cross_attn_cfg=dict(
                batch_first=True, dropout=0.1, embed_dims=128, num_heads=8),
            ffn_cfg=dict(
    ...
    neck=dict(
        ...
        type='ChannelMapper'),
    num_queries=100,
    positional_encoding=dict(normalize=True, num_feats=64),
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            name='epoch300_train2_val2_enc6_dec6_hdim128',
...
wandb_run_name = 'epoch300_train2_val2_enc6_dec6_hdim128'
work_dir = './train_results/20230814/epoch300_train2_val2_enc6_dec6_hdim128'
