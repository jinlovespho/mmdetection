...
class DetrSparseTransformerEncoder(BaseModule):
    ...
    def _init_layers(self) -> None:
        ...
        self.layers = ModuleList([
            DetrSparseTransformerEncoderLayer(**self.layer_cfg)
...
class DetrSparseTransformerDecoder(BaseModule):
    """Decoder of DETR.
    ...
    def _init_layers(self) -> None:
        ...
        self.layers = ModuleList([
            DetrSparseTransformerDecoderLayer(**self.layer_cfg)
            for _ in range(self.num_layers)
        ])
        self.embed_dims = self.layers[0].embed_dims
...
class DetrSparseTransformerEncoderLayer(BaseModule):
...
class DetrSparseTransformerDecoderLayer(BaseModule):
